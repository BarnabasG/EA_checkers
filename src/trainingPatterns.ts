...
export const STANDARD_TRAINING_PATTERNS: TrainingPatterns = {
    ...
    'STP4': {
        999: {test: true, popWeightInit: WeightInit.RANDOM, generations: 30, generationParams: { learningRate: 0.1, randPercent: 5, keepTopPercent: 15, selectionMethod: SelectionMethod.RANK, rankBias: 1.5}},
    ...
    'STP5': {
        999: {test: true, popWeightInit: WeightInit.RANDOM, generations: 30, generationParams: {learningRate: 0.25, randPercent: 5, keepTopPercent: 15, selectionMethod: SelectionMethod.RANK, rankBias: 2}},
        //999: {test: true, popWeightInit: WeightInit.RANDOM, generations: 30, generationParams: {learningRate: 0.25, randPercent: 5, keepTopPercent: 20, selectionMethod: 1, selectionPercent: 30, tournamentSize: 5}},
        //0:  {depth:2, populationSize:15, competitionType: 0, test: false},
        0:  {depth:2, populationSize:400, competitionType: 1, matchCount: 8},
        1:  {depth:2, populationSize:200, competitionType: 1, matchCount: 10},
        2:  {depth:2, populationSize:200, competitionType: 1, matchCount: 15},
        ...
        18: {depth:7, populationSize:30, competitionType: 0, generationParams: {learningRate: 0.05}},
    },
    ...
    'STP6': {
        ...
        50: {depth:6, populationSize:30, competitionType: 0, generationParams: {learningRate: 0.05}, test: true},
